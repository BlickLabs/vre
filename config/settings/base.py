...
PROJECT_DIR = ROOT_DIR.path('vre')
APPS_DIR = ROOT_DIR.path('vre/apps')
...
MAILCHIMP_CONTACT_LIST = env("MAILCHIMP_CONTACT_LIST")
MAILCHIMP_VISIT_LIST = env("MAILCHIMP_VISIT_LIST")
MAILCHIMP_DAKOTA_LIST = env("MAILCHIMP_DAKOTA_LIST")
MAILCHIMP_INDIANA_LIST = env("MAILCHIMP_INDIANA_LIST")
MAILCHIMP_TLACOTALPAN_LIST = env("MAILCHIMP_TLACOTALPAN_LIST")
MAILCHIMP_NEBRASKA_LIST = env("MAILCHIMP_NEBRASKA_LIST")
MAILCHIMP_CHICAGO_LIST = env("MAILCHIMP_CHICAGO_LIST")
